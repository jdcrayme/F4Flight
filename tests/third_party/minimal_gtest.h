...
#define EXPECT_LT(a,b) do { auto _a=(a); auto _b=(b); ::minimal_gtest::test_count()++; if(!(_a<_b)){::minimal_gtest::failure_count()++; std::printf("  FAIL %s:%d: EXPECT_LT(%g,%g)\n",__FILE__,__LINE__,(double)_a,(double)_b);} } while(0)
#define EXPECT_GT(a,b) do { auto _a=(a); auto _b=(b); ::minimal_gtest::test_count()++; if(!(_a>_b)){::minimal_gtest::failure_count()++; std::printf("  FAIL %s:%d: EXPECT_GT(%g,%g)\n",__FILE__,__LINE__,(double)_a,(double)_b);} } while(0)
#define EXPECT_LE(a,b) do { auto _a=(a); auto _b=(b); ::minimal_gtest::test_count()++; if(!(_a<=_b)){::minimal_gtest::failure_count()++; std::printf("  FAIL %s:%d: EXPECT_LE(%g,%g)\n",__FILE__,__LINE__,(double)_a,(double)_b);} } while(0)
#define EXPECT_GE(a,b) do { auto _a=(a); auto _b=(b); ::minimal_gtest::test_count()++; if(!(_a>=_b)){::minimal_gtest::failure_count()++; std::printf("  FAIL %s:%d: EXPECT_GE(%g,%g)\n",__FILE__,__LINE__,(double)_a,(double)_b);} } while(0)
#define SUCCEED() do { ::minimal_gtest::test_count()++; } while(0)
...
#define ASSERT_GE(a,b) do { if(!((a)>=(b))){::minimal_gtest::failure_count()++; std::printf("  FAIL %s:%d: ASSERT_GE\n",__FILE__,__LINE__); return;} } while(0)
#define ASSERT_LE(a,b) do { if(!((a)<=(b))){::minimal_gtest::failure_count()++; std::printf("  FAIL %s:%d: ASSERT_LE\n",__FILE__,__LINE__); return;} } while(0)
